...
class AlcadaView(QWidget):
    ...
    def _build(self):
        ...
        self.table.setHorizontalHeaderLabels(["Usuário","Data","Cliente","Segmento","CNPJ","AG","Tarifa","Ações"])
        self.table.verticalHeader().setVisible(False)
        hh=self.table.horizontalHeader(); hh.setSectionResizeMode(QHeaderView.Fixed)
        self.table.setColumnWidth(0,150); self.table.setColumnWidth(1,140); self.table.setColumnWidth(2,280)
        self.table.setColumnWidth(3,140); self.table.setColumnWidth(4,170); self.table.setColumnWidth(5,80)
        self.table.setColumnWidth(6,100); self.table.setColumnWidth(7,120)
    ...
    def load_recent(self, rows: List[Dict[str,Any]]):
        ...
        for r,it in enumerate(rows or []):
            ...
            filtros={"Segmento":it.get("segmento",""),"Cliente":it.get("cliente",""),"CNPJ":it.get("cnpj",""),"AG":it.get("ag",""),"Tarifa":it.get("tarifa","")}
