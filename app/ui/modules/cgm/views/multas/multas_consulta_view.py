...
DISPLAY_COLS=("Cliente","CNPJ","Segmento","AG","CC","TAR","Vlr_tar","Vlr_Aut","QTDE","Vencimento")
...
class MultasConsultaView(QWidget):
    ...
    def _open_update_dialog(self):
        ...
        def to_payload(db:Dict[str,Any])->Dict[str,Any]:
            disp_to_db={
                "Cliente":"CLIENTE","CNPJ":"CNPJ","Segmento":"SEGMENTO","AG":"AGENCIA","CC":"CONTA",
                "TAR":"TARIFA","Vlr_tar":"VALOR_TARIFA","Vlr_Aut":"VALOR_REQUERIDO","QTDE":"QTDE","Vencimento":"VENCIMENTO"
            }
            inv_map={}
