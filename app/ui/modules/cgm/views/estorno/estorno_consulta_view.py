...
class EstornoConsultaView(QWidget):
    ...
    def _build(self):
        ...
        for w in (self.ed_ag, self.ed_cc, self.ed_cli, self.ed_tar, bt_buscar): f.addWidget(w)
        f.addStretch()
    ...
    def _repo_search(self, ag: str, cc: str, cli: str,  tar: str) -> List[dict]:
